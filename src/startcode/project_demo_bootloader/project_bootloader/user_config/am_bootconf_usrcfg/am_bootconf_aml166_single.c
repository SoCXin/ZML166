...
#include <am_bootconf_usrcfg/am_bootconf_aml166.h>
#include "am_zlg116.h"
 ...
 */
static am_boot_flash_handle_t am_aml166_boot_single_flash_inst_init(void)
{
...
am_boot_firmware_handle_t am_aml166_boot_single_firmware_flash_inst_init(void)
{
    am_boot_flash_handle_t   flash_handle;
    flash_handle = am_aml166_boot_single_flash_inst_init();
...
static void __aml166_boot_single_plfm_deinit()
{
 ...
 */
static am_arm_boot_devinfo_t __g_aml166_boot_single_devinfo = {
    /**< \brief 应用代码区起始地址*/
    0x08003C00,
    /** \brief ram起始地址 */
    0x20000000,
    ...
    NULL,
    /** \brief 平台解初始化函数 */
    __aml166_boot_single_plfm_deinit,
};

int am_aml166_boot_single_inst_init()
{
    return am_arm_boot_init(&__g_aml166_boot_single_devinfo);
}
